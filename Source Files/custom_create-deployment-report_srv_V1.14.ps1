<#
.SYNOPSIS
    Creates a comprehensive post-deployment system report (HTML + PDF) for the local server and writes an execution log.
.DESCRIPTION
...
.NOTES
          FileName: custom_create-deployment-report_srv_V1.14.ps1
          Solution: MDT Deployment Report for Windows Server
