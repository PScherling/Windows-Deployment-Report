...
.NOTES
          FileName: custom_create-deployment-report_clt_V1.10.ps1
          Solution: 
...
$_"
	...
	Add-Content $global:FilePath -Value @"
    <h2>SNMP Windows Feature on Demand</h2>
"@
...
$_"
	...
	Add-Content $global:FilePath -Value @"
    <h2>Link-Local Multicast Resolution (LLMNR) Configuration</h2>
	<table>
	<tbody>
"@
...
$_"
	...
	Add-Content $global:FilePath -Value @"
    <h2>WDigest Credential Caching Configuration</h2>
	<table>
	<tbody>
"@
...
"@
		...
		Write-Log "ERROR: Cannotfetch SMBv1 information.."
		Add-Content $global:FilePath -Value @"
		<tr>
        <td>Implemented Setting:</td>
        <td>Cannot fetch SMBv1 information. &#10060</td>
        </tr>
"@
	}
