...
.NOTES
          FileName: custom_create-deployment-report_srv_V1.8.ps1
          Solution: 
...
"@
    ...
    elseif ($WinRMSvc.Status -ne 'Running') {
		...
		Write-Log "ERROR: $($WinRMSvc.DisplayName) - $($WinRMSvc.Name) is not running."
		Add-Content $global:FilePath -Value @"
		<tr>
        <td>Actual Setting:</td>
...
$_"
	...
	#Create Table
    Add-Content $global:FilePath -Value @"
    <h2>System Storage Information</h2>
    <table>
    <tbody>
    <tr>
    <th>Volume Name</th>
...
$_"
	...
	Add-Content $global:FilePath -Value @"
    <h3>Remote Desktop Service Status</h3>
	<table>
	<tbody>
"@
...
"@
	...
	if ($currentSignature -ne $true) {
		Write-Log "SMBv3 signing is not enabled."
		Add-Content $global:FilePath -Value @"
		<tr>
        <td>Actual Setting:</td>
...
"@
		...
		Write-Log "SMBv3 signing is already enabled."
		Add-Content $global:FilePath -Value @"
		<tr>
        <td>Actual Setting:</td>
...
"@
	...
	Write-Host "########################################" `n
	Write-Log "Checking Administrator."
	...
	Add-Content $global:FilePath -Value @"
    <h2>Backup Server Security Compliance</h2>
"@
	Write-Host "########################################"
	...
	Write-Host "########################################"
	Write-Host "#      Checking WinRMStatus            #"
	Write-Host "########################################" `n
	Write-Log "Checking WinRMStatus."
	Get-WinRMSvcStatus
	
	Write-Host "########################################"
	Write-Host "#      Checking RemoteRegistryStatus   #"
	Write-Host "########################################" `n
