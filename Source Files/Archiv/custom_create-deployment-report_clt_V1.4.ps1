...
$global:FileShare = "\\192.168.121.66\DeploymentShare$\Custom\Scripts\DeploymentReport\Media"
...
function FlushVariables {
	...
	Write-Warning "IMPORTANT! Do not forget to enable 'Secure Boot' in the systems BIOS settings after completion of the deployment."
}
