...
.NOTES
		  ...
		  Version - 0.1.10 - () - Reorganizing the report.
		  Version - 0.1.11 - () - Adding Progress Information.
...
function Get-RemoteRegistrySvcStatus {
	try {
...
"@
	...
	else{ #($RemoteRegistrySvc.StartType -ne "Disabled") {
...
"@
	...
	else{ #($WinRMSvc.StartType -ne "Disabled") {
...
function Get-WinHttpAutoProxySvcStatus {
	try {
...
function Get-WindowsScriptHost {
	try {
...
$_"
	...
	try {
		$regValue1 = Get-ItemProperty -Path "$($regPath1)" -Name "EnableCertPaddingCheck"
		$regValue2 = Get-ItemProperty -Path "$($regPath2)" -Name "EnableCertPaddingCheck"
	}
	catch {
		Write-Warning "Something went wrong. Could not fetch CertPaddingCheck information."
		Write-Warning " Error Message: $_"
...
"@
	...
	if ($regValue1.EnableCertPaddingCheck -eq "1") {
...
"@
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking Windows Script Host:" -PercentComplete 44
	Write-Host "########################################"
	Write-Host "# Checking Windows Script Host"
	Write-Host "########################################" `n
	Write-Log "Checking Windows Script Host."
	Get-WindowsScriptHost
	
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking NetBIOS:" -PercentComplete 46
	Write-Host "########################################"
	Write-Host "# Checking NetBIOS"
	Write-Host "########################################" `n
	Write-Log "Checking NetBIOS."
	Get-NetBIOS
	
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking WinHttpAutoProxy:" -PercentComplete 48
	Write-Host "########################################"
	Write-Host "# Checking WinHttpAutoProxy"
	Write-Host "########################################" `n
	Write-Log "Checking WinHttpAutoProxy."
	Get-WinHttpAutoProxySvcStatus
	
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking WinRM Status:" -PercentComplete 50
	Write-Host "########################################"
	Write-Host "# Checking WinRM Status"
	Write-Host "########################################" `n
	Write-Log "Checking WinRMStatus."
	Get-WinRMSvcStatus
	
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking RemoteRegistry Status:" -PercentComplete 52
	Write-Host "########################################"
	Write-Host "# Checking RemoteRegistry Status"
	Write-Host "########################################" `n
	Write-Log "Checking RemoteRegistryStatus."
	Get-RemoteRegistrySvcStatus
	
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking RDP Status:" -PercentComplete 54
	Write-Host "########################################"
	Write-Host "# Checking RDP Status"
	Write-Host "########################################" `n
	Write-Log "Checking RDP Status."
...
"@
	...
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking RDP in Windows Firewall:" -PercentComplete 55
	Write-Host "########################################"
	...
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking ICMP in Windows Firewall:" -PercentComplete 56
	Write-Host "########################################"
	...
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking Windows Firewall:" -PercentComplete 57
	Write-Host "########################################"
...
"@
	...
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking IPv6:" -PercentComplete 58
	Write-Host "########################################"
	...
	Write-Progress -id 1 -Activity "Generating Deployment Report" -Status "Checking First Logon Animation:" -PercentComplete 59
	Write-Host "########################################"
